...
None of that work requires starting from scratch.
A reader can open the relevant notebook, substitute data from another country or a later period, and re-run the entire analysis in a browser.
