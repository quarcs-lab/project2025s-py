# Submission bundle — April 10, 2026
...
| `manuscript-standalone.html` | ~21 MB | Single-file HTML version with all figures, math, CSS, and MathJax embedded. Opens in any browser without internet. Blinded. |
...
Bundle summary: 26 files, total ~58 MB. Generated from source commit `65976b9`.
